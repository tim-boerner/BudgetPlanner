...
import { IncomeCalculatorSharedModule, UserRouteAccessService } from './shared';
import { IncomeCalculatorAppRoutingModule} from './app-routing.module';
import { IncomeCalculatorHomeModule } from './home/home.module';
...
@NgModule({
    imports: [
        BrowserModule,
        IncomeCalculatorAppRoutingModule,
...
export class IncomeCalculatorAppModule {}
